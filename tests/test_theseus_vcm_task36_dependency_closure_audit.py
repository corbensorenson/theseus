...
import theseus_vcm_task36_dependency_closure_audit as owner  # noqa:E402
REPORT=owner.audit(ROOT/"configs"/"theseus_vcm_task36_dependency_closure_audit.json")
def test_audit_rederives_all_crates_store_and_source()->None:
 assert REPORT["trigger_state"]=="GREEN" and REPORT["observations"]["lock_checksum_package_count"]==REPORT["observations"]["matched_checksum_count"]==32
 assert REPORT["observations"]["retained_store_file_count"]==1302 and REPORT["observations"]["source_file_count"]==851
