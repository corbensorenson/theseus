...
import theseus_p4v2r2r1_autonomous_launch as launcher  # noqa: E402


CONFIG_PATH = ROOT / "configs" / "theseus_p4v2r2r1_autonomous_launch.json"
...
def test_recovery_launch_is_exact_and_has_no_human_or_token_gate() -> None:
    value = config()
