...
import theseus_semantic_ir_production_adequacy_replacement_04_task_pool as pool  # noqa: E402


def test_replacement_packet_is_sealed_and_parent_only() -> None:
    report = pool.materialize()
    assert report["trigger_state"] == "GREEN"
    assert report["opaque_task_id"] == "semantic-ir-adequacy-04r1"
...
def test_task_has_only_declared_effect_authority() -> None:
    ...
    assert task["allowed_effect_paths"] == ["skbio/alignment/_pair.py"]
