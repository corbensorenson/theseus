...
POLICY = "project_theseus_vcm_v4_chunked_route_preflight_audit_v2"
...
def audit(path: Path = DEFAULT_CONFIG):
    ...
    faults=[]
    for key in ("row_count","route_count","packet_count","source_file_count","source_chunk_count","reconstructed_source_file_count","vcm_flat_physically_addressable_matched_pair_count","consumed_v3_prompt_identity_count","rows"):
