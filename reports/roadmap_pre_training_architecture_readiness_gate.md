...
- AI_book authored source files: `4578`
- Stale book-linked phases: `0`
- Unresolved book-to-roadmap backlog items: `383`
...
- Planned Codex backlog blocked/queued: `0`
- Planned Codex backlog status counts: `{'terminal_E3_mechanics_green_efficacy_inconclusive_worker_inadequate': 3, 'retired_by_pretraining_verdict': 3, 'implemented_negative_result_rung_falsified': 1, 'partial': 1, 'pretraining_wired_behavior_qualification_pending': 10, 'terminal_E2_E3_zero_useful_cost_contrast_inconclusive_worker_inadequate': 1, 'implemented_E4_claim_scoped_disposition': 1, 'protected_discovery_lane': 1, 'planned': 1, 'terminal_E2_inconclusive_worker_inadequate_heldout_preserved': 1, 'terminal_E3_deterministic_quality_wall_learned_routing_still_blocked_by_D2': 1, 'wired': 4, 'implemented_E0_E4_integrity_and_disposition': 1, 'implemented': 1}`
...
- Pre-training architecture blockers: `1`
...
| 8 Resource, Cost, And Mac Acceleration Routing | partial | critical | `resource_and_acceleration` | 1 | 0 |
...
- `pre_training_architecture_readiness`: architecture_not_ready_for_training {"blocker_count": 1, "ready": false, "rule": "complete book-derived architecture slices before training, public calibration, or score-chasing"}

## Pre-Training Architecture Readiness

- Ready: `False`
- Blockers: `1`
- unfinished_architecture_prerequisite_phases: {"count": 1, "kind": "unfinished_architecture_prerequisite_phases", "phases": [{"missing_item_count": 2, "missing_source_artifact_paths": [], "phase": 0, "smallest_next_patch": "Keep the hold installed and preserve the append-only v8 consumption evidence. Review and commit the maintenance transaction, establish independent encrypted custody, and generate the source-bound replacement package exactly once from the clean commit. Do not execute D2 or create an incidental benchmark family.", "status": "partial", "title": "Repository Self-Model And Registry Discipline"}], "required_action": "Complete or explicitly external-freeze every architecture prerequisite before making training the primary roadmap focus."}
