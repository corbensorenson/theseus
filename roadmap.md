...
2. **K1 - decision-grade semantic representation and corpus.** Replace wrapper-shaped
   ...
   **K1i licensed human entity/coreference topology (`GREEN`, 2026-07-18):**
   ...
   replay takes 5,389.173s/5,404.007s, admits all 27,941 rows with zero verification
   failures and zero producer-authority reuse, and reproduces candidate digest
   `sha256:66915f84a4bda83f584e298a6724d570c70f26be606f8f4de8b1cb2ed0ae481a`.
   Warm producer/verifier replay takes 230.925s/181.282s with 27,941/27,941 candidate,
   finalization, economics, and semantic-admission hits and zero misses. The two SQLite
   stores cost 8,402,055,168 bytes (7.825 GiB). Raw parsing, split reconstruction,
