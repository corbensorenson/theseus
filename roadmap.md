...
7. Claude's later book-mining pass does not add another lane; it sharpens the
   ...
   per-candidate note. This confirms the remaining wall is semantic/action body
   construction, not another narrow malformed-token, local-return, or
   summary-function guard family.
