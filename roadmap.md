...
`0.352399`; verifier macro balanced accuracy is `0.761492` with `1.0` minimum negative
recall; but all four informative residual channels remain at `0.5` macro balanced
accuracy, matching their majority baselines. This is now the mechanics repair target,
...
protected-span abstention, residual-objective repair, calibrated verifier behavior, full-size multi-seed
