...
| D1 successor | `WORKER_V2_ACTIVE_DEVELOPMENT_0_OF_3` | Consumed diagnosis is complete: 0/3 useful, 3/3 exact rollback, 0/3 unsafe. Controller retrieval/recovery is repaired and tested; fresh source-disjoint qualification remains unopened |
