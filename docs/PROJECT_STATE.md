...
| Semantic-IR independent adequacy | `PREREGISTERED_SOURCE_ACQUISITION_OPEN_ZERO_CALLS` | The independent design requires 18 distinct post-snapshot repositories, at least 13/18 overall and 2/3 in each of six edit strata, all identity/corruption/known-positive controls, and zero unsafe or physical-boundary events. The exact false-positive probability is 0.0481 and power at an 0.80 mechanics rate is 0.8671; source materialization has not yet opened model or Luna calls |
