...
| Active VCM claim | `VCM_V3_K2_03_RISK_EXECUTOR_V6_PROSPECTIVELY_SEALED` | V6 has zero network/acquisition authority, verifies and replays retained Bun/Yarn stores, retains the TypeScript diagnostic, and continues independently to Rust after a non-safety TypeScript failure |
...
`typescript_diagnostic_and_rust_risk_receipt_not_executed_or_audited`.
The next legal action is
`execute_v6_zero_network_typescript_diagnostic_and_independent_rust_then_audit`.
