...
| Active VCM claim | `VCM_V3_TASK_30_CARGO_CLOSURE_INDEPENDENTLY_GREEN_TASK_26_UV_SEAL_NEXT` | Required closures 1-6 are independently GREEN. Task 30's 50-checksum Cargo closure replays offline and rederives; schedule ordinal 6 is task 26's one identical UV closure |
...
schedule ordinal 6 is task 26's one identical parent/target uv lock.
...
10. **Active:** complete the VCM evaluator instrument without opening model
   ...
   **Complete:** task 30's single identical parent/target Cargo closure is
   ...
   static audit rederives the 50-checksum closure. Prospectively seal task 26's
   single identical parent/target uv closure before expanding.
